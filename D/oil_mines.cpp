...
//  n companies and m oil mines having values.
// You have to distribute the mines to "n" companies in fair 
// manner. Remember the companies can have oil 
// mines adjacent to each other and not in between of each 
// others.After distributing them compute the 
// difference of oil mines from the company getting highest and
//  company getting lowest. This number 
